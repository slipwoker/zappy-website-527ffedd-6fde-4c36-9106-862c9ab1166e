    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "SERENITY TRAVEL משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '527ffedd-6fde-4c36-9106-862c9ab1166e',
                    name: data.name || '',
                    email: data.email || '',
